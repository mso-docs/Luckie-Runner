    ...
    towns: [
        {
            ...
            setpieces: [
                ...
                ,{ id: 'shore_fronds_start', name: 'Fronds Start', x: 6500, y: 0, width: 409, height: 395, frameWidth: 1022, frameHeight: 988, tileX: false, layer: 'midground', autoAlignToGround: true, sprite: 'art/bg/town backdrop/frond-start.png' }
                ,{ id: 'shore_fronds_mid', name: 'Fronds Mid', x: 6909, y: 0, width: 2682, height: 395, frameWidth: 1022, frameHeight: 988, tileX: true, tileWidth: 1022, layer: 'midground', autoAlignToGround: true, sprite: 'art/bg/town backdrop/fronds.png' }
                ,{ id: 'shore_fronds_end', name: 'Fronds End', x: 9591, y: 0, width: 409, height: 395, frameWidth: 1022, frameHeight: 988, tileX: false, layer: 'midground', autoAlignToGround: true, sprite: 'art/bg/town backdrop/frond-end.png' }
            ],
            interiors: []
        }
    ]
